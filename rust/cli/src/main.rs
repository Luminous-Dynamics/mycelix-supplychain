...
#[command(about = "Mycelix Supply Chain CLI - Verifiable supply chain provenance", long_about = None)]
#[command(version)]
struct Cli {
    #[command(subcommand)]
    command: Commands,
    ...
    /// API base URL
    #[arg(long, env = "SUPPLYCHAIN_URL", default_value = "http://localhost:8080")]
    url: String,
